...
public class J05_AssertionsDemo {
    ...
    static class Calculrator{
        ...
        public int multiply(int i, int b) {
            return i*b;
        }
    }
    ...
    void timeoutNotExceededWithMethod() {
        ...
        String actualGreeting = assertTimeout(ofMinutes(2), J05_AssertionsDemo::greeting);
